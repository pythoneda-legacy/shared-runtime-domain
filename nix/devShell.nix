rec {
  shellHook-for = { package, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[34mhttps://github.com/pythoneda-runtime-scope/base\033[0m";
    ...
    echo;
    echo " Thank you for using pythoneda-runtime-scope/base, PythonEDA in general, and for your appreciation of free software.";
    echo;
  '';
